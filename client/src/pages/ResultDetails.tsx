    ...
    <div className="lgm-details" style={{ minHeight: "100vh", background: BG, padding: "40px 16px" }}>
      ...
      <div ref={contentRef} className="lgm-fade-up" style={{ maxWidth: "720px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "inline-block", background: "rgba(57,255,20,0.12)", border: "1px solid rgba(57,255,20,0.3)", borderRadius: "100px", padding: "6px 18px", marginBottom: "20px" }}>
            <span style={{ color: "#39ff14", fontSize: "10px", fontWeight: 800, letterSpacing: "3px", textTransform: "uppercase" }}>Próximo passo</span>
          </div>
          <h3 style={{ color: "#fff", fontSize: "clamp(20px, 3.5vw, 26px)", fontWeight: 900, lineHeight: 1.2, marginBottom: "14px" }}>
            Você identificou o seu modelo.<br />
            <span style={{ color: "#39ff14" }}>Agora vamos implementá-lo.</span>
          </h3>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "14px", lineHeight: 1.75, maxWidth: "520px", margin: "0 auto 28px" }}>
            O diagnóstico mostra o caminho. A reunião estratégica transforma isso em ação concreta dentro da realidade do seu negócio. Em 30 minutos, você sai com clareza sobre como intensificar o {details.name} no seu contexto específico.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", maxWidth: "400px", margin: "0 auto 28px" }}>
            {[
              "Como aplicar o modelo à sua fase atual de crescimento",
              "Onde concentrar energia para ter resultado mais rápido",
              "Como combinar modelos sem perder foco",
            ].map((item, i) => (
              <div key={i} style={{ display: "flex", gap: "10px", alignItems: "flex-start", textAlign: "left" }}>
                <span style={{ color: "#39ff14", fontWeight: 800, fontSize: "14px", flexShrink: 0, marginTop: "1px" }}>✓</span>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "13px", lineHeight: 1.55, margin: 0 }}>{item}</p>
              </div>
            ))}
          </div>
          <a
            href={`https://wa.me/5561992141518?text=${encodeURIComponent("Respondi o diagnóstico e desejo marcar uma reunião estratégica de implementação")}`}
            target="_blank"
          ...
          >
            ...
            Marcar minha reunião estratégica
          </a>
          <p style={{ color: "rgba(255,255,255,0.25)", fontSize: "11px", marginTop: "14px", letterSpacing: "0.5px" }}>
            Gratuita · 30 minutos · Via WhatsApp
          </p>
        </div>
